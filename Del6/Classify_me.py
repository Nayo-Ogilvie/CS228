...
knn = KNN()
"""
test0String = "./userData/Genovese_test0.p"
pickle_in = open(test0String,"rb")
test0 = pickle.load(pickle_in)

train0String = "./userData/Genovese_train0.p"
        ...
        for finger in range(0,5):
            for bone in range(0,2):
                for tipBase in range(0,3):
                    ...
                    #X[row+2000,col] = set3[finger,bone,tipBase,row]
                    #X[row+3000,col] = set4[finger,bone,tipBase,row]
                    #X[row+4000,col] = set5[finger,bone,tipBase,row]
                    #X[row+5000,col] = set6[finger,bone,tipBase,row]
                    #X[row+6000,col] = set7[finger,bone,tipBase,row]
                    #X[row+7000,col] = set8[finger,bone,tipBase,row]
                    #X[row+8000,col] = set9[finger,bone,tipBase,row]
                    #X[row+9000,col] = set10[finger,bone,tipBase,row]
                    col = col + 1
    return X, Y
